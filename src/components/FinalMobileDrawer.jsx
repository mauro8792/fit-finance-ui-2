  ...
  const renderMenuItems = () => {
    ...
    if (userType === 'coach') {
      return (
        <>
          ...
          <MobileMenuItem title='Cuotas' to='/coach/fees' icon={<PaidIcon />} selected={selected} setSelected={setSelected} onClose={onClose} />
    ...
    return (
      <>
        ...
        <MobileMenuItem title='Gestión Alumnos' to='/admin-students' icon={<SchoolIcon />} selected={selected} setSelected={setSelected} onClose={onClose} />
