...
import AdminStudents from './scene/admin-students';
import NewStudentPage from './scene/admin-students/NewStudentPage';
import EditStudentPage from './scene/admin-students/EditStudentPage';
...
import PaymentHistory from './scene/student/PaymentHistory';
...
import EditMicrocycleSetsPage from './scene/coach/EditMicrocycleSetsPage';
import ExerciseCatalogManager from './scene/coach/ExerciseCatalogManager';
import { TemplateLibrary } from './scene/coach/templates';
import CreateTemplatePage from './scene/coach/templates/CreateTemplatePage';
            ...
            <Route element={<Layout showFooter={false} />}>
              ...
              {userType === 'coach' && (
                <>
                  ...
                  <Route path="/coach/microcycle/:microcycleId/edit-sets" element={<EditMicrocycleSetsPage />} />
                  <Route path="/coach/microcycle/:microcycleId/add-exercise" element={<AddExercisePage />} />
                  ...
                  <Route path="/coach/templates/new" element={<CreateTemplatePage />} />
              ...
              {(userType === 'admin' || userType === 'superadmin') && (
                <>
                  ...
                  <Route path="/admin-students/edit/:studentId" element={<EditStudentPage />} />
